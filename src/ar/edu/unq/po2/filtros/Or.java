...
import ar.edu.unq.po2.Muestra;
	 ...
	 * @note Esta clase tiene como objetivo modelar el Filtro Or como Composite miembro del Patron Composite.
	 * @see IBusqueda, And, Filtro
	 * @DesignPattern Composite <<Composite>> 
	 *
	 */
public class Or implements IBusqueda {
	
	private IBusqueda filtro1;
	private IBusqueda filtro2;

	public Or(IBusqueda filtro1, IBusqueda filtro2) {
		super();
	...
	public Set<Muestra> filtrarMuestras(Set<Muestra> muestras) {
		...
		Set<Muestra> setResultante = new HashSet<Muestra>();
		setResultante.addAll(resultadosFiltro1);
		setResultante.addAll(resultadosFiltro2);
